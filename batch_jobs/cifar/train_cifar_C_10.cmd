...
#SBATCH --gres=gpu:1
#SBATCH --time=5:00:00
#SBATCH -o outs/cifar_C_10.out
#SBATCH -e outs/cifar_C_10.out
...
enroot start --mount $(pwd):/workspace mmcl_rvcl <<'EOF'
    ...
    python train_mmcl.py \
        --model_save_name cnn_4layer_b_C_10_poly_3 \
        --model cnn_4layer_b \
        --dataset cifar-10 \
        --batch_size 32 \
        --kernel_type poly \
    ...
    if [ $? -eq 0 ]; then
        ...
        python -u train_linear_eval.py \
            ...
            --lr 1e-3 \
            --model cnn_4layer_b \
            --mmcl_checkpoint models/mmcl/polu/cnn_4layer_b_C_10_poly_3.pkl \
            --adv_img
    else
