...
#SBATCH --gres=gpu:1
#SBATCH --time=5:00:00
#SBATCH -o outs/cifar_C_1000_100k.out
#SBATCH -e outs/cifar_C_1000_100k.out
...
enroot start --mount $(pwd):/workspace mmcl_rvcl <<'EOF'
    ...
    python train_encoder.py \
        --model_save_name cnn_4layer_b_C_1000_rbf_gamma \
        --model cnn_4layer_b \
        --dataset cifar-10 \
        --batch_size 32 \
        --kernel_type rbf \
    ...
    if [ $? -eq 0 ]; then
        ...
        python -u train_linear_eval.py \
            ...
            --lr 1e-4 \
            --model cnn_4layer_b \
            --load_checkpoint models/mmcl/rbf/cnn_4layer_b_C_1000_rbf_gamma.pkl \
            --adv_img
    else
