...
#SBATCH -o outs/randomized_smoothing_cl.out
#SBATCH -e outs/randomized_smoothing_cl.out
...
enroot start --mount $(pwd):/workspace mmcl_rvcl <<'EOF'
    ...
    python -u randomized_smoothing/compare_randomized_smoothing_supervised.py \
        --num_images 200
