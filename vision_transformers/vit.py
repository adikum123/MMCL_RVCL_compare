...
from vision_transformers.layers import TransformerEncoder


class ViT(nn.Module):

    def __init__(
        self, in_c=3, num_classes=10, img_size=32, patch=8, dropout=0., num_layers=7, hidden=384, mlp_hidden=384*4, head=8, is_cls_token=True
    ):
