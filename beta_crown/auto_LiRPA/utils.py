...
logging.basicConfig(
    format="%(levelname)-8s %(asctime)-12s %(message)s", datefmt="%H:%M:%S"
)
...
Patches = namedtuple_with_defaults(
    "Patches",
    ("patches", "stride", "padding", "shape", "identity"),
    defaults=(None, 1, 0, None, 0),
)
...
LinearBound = namedtuple_with_defaults(
    "LinearBound",
    (
        "lw",
        "lb",
