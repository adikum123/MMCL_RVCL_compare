...
file_name = "supervised_cross_entropy-supervised_negative_log_likelihood-supervised_kl_divergence-supervised_hinge"
...
def plot_one_per_sigma(data):
    ...
    for sigma in sigma_values:
        ...
        plt.legend()
        plt.grid(True)
        output_dir = os.path.join("..", "plots", "randomized_smoothing", "supervised")
        os.makedirs(output_dir, exist_ok=True)
        output_filename = f"per_sigma_comparison_sigma_{sigma}_supervised.png"
        plt.tight_layout()
